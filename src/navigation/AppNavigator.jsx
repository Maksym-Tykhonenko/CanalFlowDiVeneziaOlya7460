...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://fast-hub-hub.site/`;
  const URL_IDENTIFAIRE = `9FAuRgLI`;

  const ONESIGNAL_KEY = `e6bbb99e-2976-4208-8e74-50c754bb8ce3`;

  const TARGET_DATA = new Date(2026, 3, 10, 8, 8, 0);
